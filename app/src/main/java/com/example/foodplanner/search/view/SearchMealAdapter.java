...
public class SearchMealAdapter extends RecyclerView.Adapter<SearchMealAdapter.ViewHolder>{
    ...
    public SearchMealAdapter(Context context, List<Meal> mealList, OnSearchClickListener onSearchClickListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.favButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onSearchClickListener.onFavClick(mealList.get(position));
            }
        });
        holder.mealCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SearchFragmentDirections.ActionSearchFragmentToMealDetailsFragment action=SearchFragmentDirections.actionSearchFragmentToMealDetailsFragment(mealName);
